...
// alert(menuObj.subMenuList[1].name);
	...
	var id = menuObj.id;
	var clickEvent = menuObj.clickEvent;
	
	var attrArray = initAttrArray(len, id, clickEvent);
...
function initAttrArray(subElementlen, id, clickEvent){
	var attrArray = [];
	attrArray.push({"key" : "onClick", "value" : clickEvent});
